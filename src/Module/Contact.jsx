      ...
      >
        ...
        >
          ...
          <ul className="w-full space-y-4">
            {[ 
              { title: "Whatsapp", icon: FaWhatsapp, url: "https://wa.me/86279806", user: "stevengazo" },
              { title: "Linkedin", icon: FaLinkedin, url: "https://www.linkedin.com/in/stevengazo/", user: "stevengazo" },
              { title: "Email", icon: FaMailBulk, url: "mailto:steven.gazo@hotmail.com", user: "steven.gazo@hotmail.com" },
              { title: "GitHub", icon: FaGithub, url: "https://github.com/stevengazo", user: "stevengazo" },
            ].map((item, i) => (
